...
export function AppHeader({ pathname }: { pathname: string }) {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 grid h-14 w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-b border-sidebar-border bg-secondary px-3 text-secondary-foreground shadow-sm sm:px-4">
